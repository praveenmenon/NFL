...
alexa.response = function() {
  ...
  this.say = function(str) {
    console.log("str:",str);
    console.log("response output speech:",this.response.response.outputSpeech);
    if (typeof this.response.response.outputSpeech == "undefined") {
      ...
      console.log("response output speech:",this.response.response.outputSpeech);
      // console.log("final returned this 1:",this);
    } else {
    ...
    // console.log("final returned this 2:",this);
    return this;
  };
  ...
  this.reprompt = function(str) {
    if (typeof this.response.response.reprompt == "undefined") {
      ...
      // console.log("response output reprompt:",this.response.response.reprompt);
    } else {
      // append str to the current outputSpeech, stripping the out speak tag
  ...
  this.card = function(oCard) {
    if (2 == arguments.length) {  //backwards compat
      // console.log("inside oCard if statement");
      oCard = {
        type: "Simple",
        title: arguments[0],
        content: arguments[1]
    ...
    switch (oCard.type) {
      case 'Simple':
        // console.console.log("card type simple");
    ...
    // console.log("this.response.response.card:",this.response.response.card);
    return this;
  };
...
alexa.app = function(name, endpoint) {
  ...
  this.intent = function(intentName, schema, func) {
    console.log("Intent function:",func);
    console.log("Intent name:",intentName);
    console.log("Intent schema:",schema);
